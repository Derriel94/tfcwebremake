	...
	return (
     ...
     <img className="banner" src='./banner.png' />
        ...
        <p className="wavetext">
          A called, faithful woman of GOD, Mother of two adult sons,
          sister and daughter.
          I have served in ministry for over 25 years. 
          Spear heading Bible Studies and starting Gospel Services 
          around the world to help encourage soldiers while deployed. 
          I have served over 21 years of service in the United States 
          Army. With an education background of a degree in Applied 
          Technology, Graduate of the Sonship School of the Firstborn and 
          Completion of Beatitudes and the Kingdom of GOD at 
          Christian Life School of Theology out of Columbus, GA.
        </p>
